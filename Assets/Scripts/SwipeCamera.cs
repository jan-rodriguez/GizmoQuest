...
public class SwipeCamera : MonoBehaviour {
	...
	private const float CAM_MIN_X_POS = -19.0f;
	private const float CAM_MAX_X_POS = 19.0f;
	...
	void SwipeToPosition (Vector3 swipePos) {
		...
		Camera.main.transform.position = new Vector3 (Mathf.Clamp (camPos.x, CAM_MIN_X_POS, CAM_MAX_X_POS), camPos.y, camPos.z);
